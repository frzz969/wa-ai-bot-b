...
const CATEGORIES = [
  ...
  { tag: 'vision', title: '👁️ VISION & VOICE', items: [
    ['@grup', 'Gambar — tanya AItentang gambar:'],
    ['ai', 'analisa gambar', { reply: true }],
  ...
  { tag: 'dlain', title: '⬇️ DOWNLOAD LAIN', items: [
  ...
  { tag: 'ramalan', title: '🔮 PRIMBON & SERU', items: [
  ...
  { tag: 'ekstra', title: '🛠️ UTILITAS LANGSIA', items: [
