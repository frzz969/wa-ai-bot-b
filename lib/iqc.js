...
const PILL_ORDER = [
  ...
  { emoji: '😂', file: 'new-tears-of-joy.png' },
...
function resolveFontFile() {
  ...
  cands.push(path.join(__dirname, '..', 'assets', 'fonts', 'sf-pro-display', 'SFPRODISPLAYREGULAR.OTF'));
...
async function generateIQC(messageText, opts) {
  ...
  // Reaction bar: x=18 y=422 w=660 h=122 rx=61, 6 PNG lokal berurutan.
...
const HTML_EMOJI_IMGS = {
  ...
  '❤': '../assets/emoji-iphone/heart.png',
    '😂': '../assets/emoji-iphone/new-tears-of-joy.png',
